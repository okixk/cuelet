...
| Linux | Native Ubuntu 26.04 GNOME/Wayland x86_64 Release build from package-input commit `d4e9fadbde86f6cd100f810a49deadb765bfdcab`; 15/15 tests twice; input-derived epoch `1787332242`; reproducible archive (`Cuelet-0.1.0-linux-x86_64.tar.gz`, 568,212 bytes, SHA-256 `fd7ae472486c395cbd65eb2fb88c6e29c10574f73164912f193e7ee6cd364471`) | App-owned virtual source, Cuelet injection, optional physical-source mix, combined physical-output/virtual mode, shortcuts, and cleanup passed within the recorded scope | Broader distro packaging/publication and receiving-client coverage remain |
