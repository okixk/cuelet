...
| Linux | Native Ubuntu 26.04 GNOME/Wayland x86_64 Release build from package-input commit `261a0273b877e9a3f4804ac22c7eac7658fa8fe2`; 15/15 tests twice; input-derived epoch `1787332835`; reproducible archive (`Cuelet-0.1.0-linux-x86_64.tar.gz`, 568,213 bytes, SHA-256 `4d9d5eb5e9ab4fa6db9bdb66bc2c0c585d992c4a13d8e2346ca198b4c4a5cfa4`) | App-owned virtual source, Cuelet injection, optional physical-source mix, combined physical-output/virtual mode, shortcuts, and cleanup passed within the recorded scope | Broader distro packaging/publication and receiving-client coverage remain |
